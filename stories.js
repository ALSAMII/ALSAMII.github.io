/* ============================================================
   ...
   category / subcategory / substance feed the two dropdowns
   above the list. Reuse an existing category and subcategory
   where one fits — a new spelling makes a new menu entry. Leave
   all three out and the book simply never appears under a
   filter, but shows in the full list as normal.
   ============================================================ */
...
const STORIES = [
...

  {
    ...
    words: "16 pages",
    category: "Dose",
    subcategory: "Nothing Hurts Here",
...

  {
    ...
    words: "20,400 words",
    category: "Dose",
    subcategory: "Quiet the Basement",
